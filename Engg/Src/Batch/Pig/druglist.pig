...
drugs = foreach notnulldrugs generate com.tpgsi.jderive.StringHashCode(UPPER(TRIM(MEDICINALPRODUCT))),UPPER(TRIM(MEDICINALPRODUCT));

uniqudrug = DISTINCT drugs; 

STORE uniqudrug INTO 'CompleteDS/druglist' USING PigStorage (',');