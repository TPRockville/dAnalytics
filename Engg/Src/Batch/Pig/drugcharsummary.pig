...
grps = GROUP inputfile by (com.tpgsi.jderive.StringHashCode(UPPER(TRIM(MEDICINALPRODUCT))),TRIM(DRUGCHARACTERIZATION));
...
STORE result INTO 'CompleteDS/drugcharsummary' USING PigStorage (',');  