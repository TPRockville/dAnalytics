...
indications = foreach notnullindications generate com.tpgsi.pigudf.StringHashCode(DRUGINDICATION),DRUGINDICATION;

uniqueindication = DISTINCT indications;

STORE uniqueindication INTO 'drugindication' USING PigStorage (',');