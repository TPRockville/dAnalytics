...
grps = GROUP inputfile by (com.tpgsi.jderive.StringHashCode(UPPER(TRIM(MEDICINALPRODUCT))), com.tpgsi.jderive.AgeCategory(PATIENTONSETAGE),PATIENTSEX, com.tpgsi.jderive.WeightCategory(PATIENTWEIGHT),com.tpgsi.jderive.StringHashCode(UPPER(TRIM(REPORTERCOUNTRY))),com.tpgsi.jderive.DateRange(RECEIVEDATE));
...
STORE result INTO 'CompleteDS/drugsummarybymonth' USING PigStorage (',');  
