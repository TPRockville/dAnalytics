...
reactions = foreach notnullreactions generate com.tpgsi.pigudf.StringHashCode(REACTIONMEDDRAPT),REACTIONMEDDRAPT;

uniquereaction = DISTINCT reactions;

STORE uniquereaction INTO 'reaction' USING PigStorage (',');