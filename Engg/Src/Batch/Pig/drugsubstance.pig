...
drugsubstances = foreach notnulldrugsubstances generate com.tpgsi.jderive.StringHashCode(UPPER(TRIM(ACTIVESUBSTANCENAME))),UPPER(TRIM(ACTIVESUBSTANCENAME));

drugsubstance = DISTINCT drugsubstances;

STORE drugsubstance INTO 'CompleteDS/drugsubstance' USING PigStorage (',');