...
countries = foreach notnullcountries generate com.tpgsi.pigudf.StringHashCode(REPORTERCOUNTRY),REPORTERCOUNTRY;

uniquecountry = DISTINCT countries;

STORE uniquecountry INTO 'countries' USING PigStorage (',');